...
{
    protected $fillable = [
        'signal_id', 'group', 'tier', 'observation_en', 'observation_fa', 'features', 'detector', 'quality_gates',
        'possible_contexts', 'clinical_rationale_en', 'clinical_rationale_fa', 'clinical_note_en', 'clinical_note_fa',
